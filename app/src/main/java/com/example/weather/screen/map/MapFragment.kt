...
class MapFragment private constructor() : BaseFragment<FragmentMapBinding>(), MapContract.View, OnMapReadyCallback {
    ...
    override fun initData() {
        ...
        mPresenter = mRepository?.let { MapPresenter(it) }
    ...
    override fun initView() {
        ...
        viewBinding.layoutWeatherMap.icStar.setOnClickListener {
            if (viewBinding.layoutWeatherMap.icStar.drawable.constantState?.hashCode() == ContextCompat.getDrawable(
                    requireContext(),
    ...
    private fun bindDataToView(weather: Weather) {
        ...
        viewBinding.layoutWeatherMap.tvLocation.text = weather.city + ", " + weather.country
        val starResource =
