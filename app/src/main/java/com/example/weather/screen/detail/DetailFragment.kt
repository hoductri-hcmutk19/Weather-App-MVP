...
class DetailFragment private constructor() : BaseFragment<FragmentDetailBinding>(), OnItemClickListener {
    ...
    override fun initView() {
        ...
        viewBinding.layoutDaily.recyclerViewHourly.adapter = hourlyAdapter
        viewBinding.layoutFooter.recyclerViewHourly.adapter = hourlyAdapter
    ...
    private fun bindDataToView(weather: Weather) {
        weather.weatherHourlyList?.let {
            hourlyAdapter.updateData(
                it as MutableList<WeatherBasic>)
        }
    }
